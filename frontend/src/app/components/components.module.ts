...
} from './admin-manage-bike-rentals-component/admin-manage-bike-rentals-component.component'
import {
  BookTicketBookingInformationComponent
} from './book-ticket-booking-information-component/book-ticket-booking-information-component.component'
...
} from './booking-active-rentals-list-entry-component/booking-active-rentals-list-entry-component.component'
...
} from './button-assign-update-delete-component/button-assign-update-delete-component.component'
import {NoEntriesComponent} from './no-entries-component/no-entries-component.component'
import {
  AdminManageBikeRentalsListEntry
} from './admin-manage-bike-rentals-list-entry/admin-manage-bike-rentals-list-entry.component'
import {
  BookingActiveRentalsUserComponent
} from './booking-active-rentals-user-component/booking-active-rentals-user-component.component'
...
} from './admin-bikes-management-component/admin-bikes-management-component.component'
...
} from './book-ticket-renting-information-component/book-ticket-renting-information-component.component'
...
} from './admin-update-bike-station-component/admin-update-bike-station-component.component'
...
} from './admin-manage-bike-popup-component/admin-manage-bike-popup-component.component'
...
} from './admin-bike-station-entry-component/admin-bike-station-entry-component.component'
...
} from './booking-ticket-history-entry-component/booking-ticket-history-entry-component.component'
import {Navbar} from './navbar/navbar.component'
import {
  BookingTicketHistoryComponent
} from './booking-ticket-history-component/booking-ticket-history-component.component'
...
} from './admin-manage-model-popup-component/admin-manage-model-popup-component.component'
...
} from './admin-manage-category-popup-component/admin-manage-category-popup-component.component'
...
} from './booking-active-tickets-component/booking-active-tickets-component.component'
...
} from './admin-parking-place-selection-component/admin-parking-place-selection-component.component'
...
} from './booking-rent-bike-start-confirmation-popup-component/booking-rent-bike-start-confirmation-popup-component.component'
...
import {AdminChangeMapComponent} from "./admin-change-map-component/admin-change-map-component.component";
